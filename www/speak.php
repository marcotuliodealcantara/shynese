...
// Definindo environmental variables para Google API
//$projectDir =  __DIR__ . '/..';
  	...
  	<div class="container">
        ...
        if (isset($_POST['talk']) == 1) {
            ...
            ?>
                ...
                <span class="score">Choose which one of the two words/sentences below is contained in the audio sentence
                <br /><br />
